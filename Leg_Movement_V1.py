...
import math
import struct
from Leg_Movement_Functions import right_leg_step, initialize_can_bus, enable_motor_mode, disable_motor_mode, set_zero_position, send_motor_command
...
while True:
	try:
		...
		right_leg_step(thigh_can_id=motor2_can_id, knee_can_id=motor3_can_id, canbus=can_bus, duration=0.5, direction=1, center_y=-260)
